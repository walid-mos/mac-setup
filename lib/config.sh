...
REQUIRE_FULL_DISK_ACCESS="${REQUIRE_FULL_DISK_ACCESS:-true}"  # Check Full Disk Access before applying settings

# Dock configuration
DOCK_AUTOHIDE="${DOCK_AUTOHIDE:-false}"
DOCK_SIZE="${DOCK_SIZE:-54}"
DOCK_MAGNIFICATION="${DOCK_MAGNIFICATION:-true}"
DOCK_MAGNIFICATION_SIZE="${DOCK_MAGNIFICATION_SIZE:-96}"
DOCK_MRU_SPACES="${DOCK_MRU_SPACES:-false}"  # Disable "most recently used" spaces

# Finder configuration
FINDER_SHOW_HIDDEN="${FINDER_SHOW_HIDDEN:-false}"
FINDER_SHOW_EXTENSIONS="${FINDER_SHOW_EXTENSIONS:-false}"
FINDER_VIEW_STYLE="${FINDER_VIEW_STYLE:-Nlsv}"  # List view
...
export APPLY_MACOS_DEFAULTS RESTART_SERVICES REQUIRE_FULL_DISK_ACCESS
export DOCK_AUTOHIDE DOCK_SIZE DOCK_MAGNIFICATION DOCK_MAGNIFICATION_SIZE DOCK_MRU_SPACES
export FINDER_SHOW_HIDDEN FINDER_SHOW_EXTENSIONS FINDER_VIEW_STYLE FINDER_DISABLE_DS_STORE FINDER_HIDE_RECENT_TAGS FINDER_HIDE_NETWORK_BROWSER
export SYSTEM_DISABLE_GATEKEEPER SYSTEM_FAST_KEY_REPEAT SYSTEM_SPACES_SPAN_DISPLAYS PROMPT_COMPUTER_NAME
